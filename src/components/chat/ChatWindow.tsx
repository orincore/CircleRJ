...
import { Send, Phone, Video, Info, ArrowLeft, Paperclip, Mic, ImageIcon } from "lucide-react"
...
export const ChatWindow: React.FC<{ onOpenSidebar?: () => void }> = ({ onOpenSidebar }) => {
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center p-4">
          ...
          <h3 className="text-xl font-medium text-gray-900 dark:text-gray-100 mb-2">Your Messages</h3>
  ...
  return (
    <div className="flex-1 flex flex-col h-screen bg-white dark:bg-gray-900">
      {/* Header */}
      <div className="p-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center">
        <button
        ...
        <div className="flex items-center flex-1">
          <div className="relative">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-yellow-400 to-primary-500 p-0.5">
              <img
                src={avatarSource || "/placeholder.svg"}
          ...
          <div className="ml-3">
            <h3 className="font-medium text-gray-900 dark:text-gray-100">{selectedChat.user.name}</h3>
      ...
      {/* Attachment options */}
      {showAttachments && (
        <div className="p-2 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 grid grid-cols-4 gap-2">
